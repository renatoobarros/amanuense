# amanuense — Documentação Técnica
...
as decisões de projeto** do `amanuense` e **servir como material de
aprendizado** para quem quiser entender como sistemas desse tipo são
construídos em Rust.

Cada seção explica não apenas _o que_ foi feito, mas _por que_ aquela
